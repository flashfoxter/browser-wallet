...
class RequestSelector extends Component {
    ...
    handleChange(event) {
        ...
        this.setState({menuOpen: false});
        this.props.pageActions.changeRequest(event.target.value);
    ...
    renderValue(value) {
        ...
        console.log('value', value, requests);

        const requestInfo = requests[value];

        return (
            <Grid container justify='flex-start' className={classes.selectRenderValue}>
                <Typography noWrap={true}
                            color='inherit'>{requestInfo.method}</Typography>
            </Grid>
        );
    }
    ...
    render() {
        ...
        const menuItems = requests.map((requestInfo, index) => {
        ...
        return (
            <FormControl
                variant="filled">
                <InputLabel htmlFor="component-filled">External Request</InputLabel>
                <Select
                    variant='filled'
                    className={classes.selectInput}
                    value={this.props.requests.requestIndex}
